...
public class orderDAOImp implements orderDAO {
	...
	private String ins = "INSERT INTO slam_orders (ordr_cust_id, ordr_billno, ordr_odate, ordr_total, ordr_gst, ordr_payreference, ordr_paymode, ordr_paystatus, ordr_saddress, ordr_shipment_status,ordr_shipment_date) VALUES (?, ?, CURRENT_TIMESTAMP,?, ?, ?, ?, ?, ?, ?, CURRENT_DATE + INTERVAL '5 days') RETURNING ordr_id";
